    ...
    <section class="content">		
		<div class="card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-primary" id="registBtn" onclick="OpenWindow('registForm.do','글쓰기',700,800);">글등록</button>
			...
			<div class="card-body">
				<table class="table table-bordered text-center" >					
					...
					<c:forEach items="${boardList }" var="board">
						...
						<a href="javascript:OpenWindow('detail.do?bno=${board.bno}','상세번호',800,700);">${board.title }</a>
						</td>
						<td>${board.writer }</td>
