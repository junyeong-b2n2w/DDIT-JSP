				...
				<div class="card card-outline card-info">
					...
					<div class="card-body">
						<div class="form-group col-sm-12">
							<label for="title">제 목</label> <span class="form-control" id="title">${board.title }</span>
						</div>
						<div class="row">	
							...
							<span class="form-control" id="regDate"><fmt:formatDate value="${board.regDate }" pattern="yyyy-MM-dd HH:mm"/></span>
							</div>
							<div class="form-group col-sm-4" >
